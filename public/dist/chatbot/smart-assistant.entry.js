...
const SmartAssistant = class {
  ...
  render() {
    return h(
      'div',
      { key: '248355d56adeac6809ffe36f85265ec4a69f8444', class: 'body' },
      !this.isChatbotVisible &&
        ...
        h(
          'div',
          { class: 'chat-icon', onClick: this.handleChatClick },
          h('img', {
            style: { width: '50px', height: '50px' },
            src: '/assets/images/simba_bot.png',
            alt: 'Chatbot Icon',
          })
        ),
      this.isChatbotVisible &&
